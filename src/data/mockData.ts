...
export const mockData: Customer[] = [
  {
    ...
    salesActions: [
      ...
      {
        type: "call",
        content: "최종 승인 단계 진입, 이번 주 내 계약 예정",
        date: "2024-12-16",
        possibility: "90%",
        customerResponse: "상",
        targetRevenue: 5000000,
    ...
    contentEngagements: [
      ...
      {
        title: "계약 전 체크리스트 가이드",
        date: "2024-12-16",
        category: "BOFU",
      },
      {
        title: "영상면접 성공 도입 사례: 대기업편",
        date: "2024-12-17",
        category: "BOFU",
      },
      {
        title: "2025 채용 트렌드 웨비나",
        date: "2024-12-18",
        category: "MOFU",
      },
    ],
  ...
  },
  {
    ...
    salesActions: [
      ...
      {
        type: "call",
        content: "도입 일정 협의, 담당자 교육 스케줄 확정",
        date: "2024-12-17",
        possibility: "90%",
        customerResponse: "상",
        targetRevenue: 5000000,
      ...
      {
        type: "meeting",
        content: "시스템 세팅 미팅, 1월 2주차 오픈 예정",
        date: "2024-12-19",
        possibility: "90%",
        customerResponse: "상",
        targetRevenue: 5000000,
    ...
    contentEngagements: [
      ...
      {
        title: "시스템 도입 가이드: 첫 단계",
        date: "2024-12-16",
        category: "BOFU",
      },
      {
        title: "영상면접 담당자 교육 자료",
        date: "2024-12-17",
        category: "BOFU",
      },
      {
